package com.flowy.workers.barcodeScannerImpl;
...
public class IntentIntegrator {
	...
	private void initializeConfiguration() {
		...
		title = res.getString(R.string.installBarcodeScanner);
		message = res.getString(R.string.requiresBarcodeScanner);
		buttonYes = res.getString(android.R.string.yes);
		buttonNo = res.getString(android.R.string.no);
	 ...
	 *         to download the app if a prompt was needed, or null otherwiseo
	 */
	public final AlertDialog initiateScan(int requestCode) {
	...
	public final AlertDialog initiateScan(
			Collection<String> desiredBarcodeFormats, int requestCode) {
