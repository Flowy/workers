...
import static com.flowy.workers.Constants.HASH_FUNCTION;
import static com.flowy.workers.Constants.PERSON_COMPANY_ID;
import static com.flowy.workers.Constants.PERSON_LAST_UPDATED;
import static com.flowy.workers.Constants.PERSON_NFC_CODE;
import static com.flowy.workers.Constants.PERSON_PASSWORD_HASH;
import static com.flowy.workers.Constants.PERSON_QR_CODE;
...
public class Person implements Entity {
	...
	public ContentValues toRow() {
		...
		values.put(PERSON_QR_CODE, qrCode);
		values.put(PERSON_NFC_CODE, nfcCode);
		values.put(PERSON_LAST_UPDATED, lastUpdated.getTime());
		return values;
	}
